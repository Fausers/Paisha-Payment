...
@section('content')
	...
	<div class="inner_table shadow5">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="bridcrumb">	<a href="#">Home</a> / Archive</div>
				</div>
			</div>
					...
					<div class="author_about">
						<div class="author_img">
							<div class="author_wrap">
								<img src="{{url('/')}}/mwangaza/assets/img/author/author1.png" alt="">
							</div>
						</div>
						<div class="author_content">	<a href="#">QuomodoSoft</a>
							<ul class="inline">
								<li>News Writer</li>
								<li>Since: April 25, 2020</li>
							</ul>
						</div>
						<p>QuomodoSoft is an investigative reporter for Newspark, based in Bangladesh. He started at The Times in 1999 covering Mayor Rudolph W. Giuliani and then the Sept. 11, 2001, attacks.</p>
						<br>
					...
					<div class="row">
						...
						<div class="col-2 text-right align-self-center">
							<div class="calender mb20">
								<img src="{{url('/')}}/mwangaza/assets/img/icon/calendar.png" alt="">
							</div>
						</div>
					</div>
								...
								<div class="row justify-content-center">
									...
									<div class="col-lg-6">
										<div class="single_post post_type3 mb30">
											<div class="post_img">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/entertrainment/enter1.jpg" alt="">
												</a>
											</div>
											<div class="single_post_text">
												<div class="meta3">	<a href="#">TECHNOLOGY</a>
									...
									<div class="col-lg-6">
										<div class="single_post post_type3 mb30">
											<div class="post_img">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/entertrainment/enter2.jpg" alt="">
												</a>
											</div>
											<div class="single_post_text">
												<div class="meta3">	<a href="#">TECHNOLOGY</a>
									...
									<div class="col-lg-6">
										<div class="single_post post_type3 mb30">
											<div class="post_img">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/entertrainment/enter3.jpg" alt="">
												</a>
											</div>
											<div class="single_post_text">
												<div class="meta3">	<a href="#">TECHNOLOGY</a>
									...
									<div class="col-lg-6">
										<div class="single_post post_type3 mb30">
											<div class="post_img">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/entertrainment/enter4.jpg" alt="">
												</a>
											</div>
											<div class="single_post_text">
												<div class="meta3">	<a href="#">TECHNOLOGY</a>
				...
				<div class="col-md-6 col-lg-4">
								...
								<div class="widget tab_widgets mb30">
									<div class="single_post widgets_small">
										<div class="post_img">
											<div class="img_wrap">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/header/widget/tab1.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="single_post_text">
									...
									<div class="single_post widgets_small">
										<div class="post_img">
											<div class="img_wrap">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/header/widget/tab2.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="single_post_text">
									...
									<div class="single_post widgets_small">
										<div class="post_img">
											<div class="img_wrap">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/header/widget/tab3.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="single_post_text">
									...
									<div class="single_post widgets_small">
										<div class="post_img">
											<div class="img_wrap">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/header/widget/tab4.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="single_post_text">
									...
									<div class="single_post widgets_small">
										<div class="post_img">
											<div class="img_wrap">
												<a href="#">
													<img src="{{url('/')}}/mwangaza/assets/img/header/widget/tab5.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="single_post_text">
					...
					<div class="carousel_post_type3_wrap mb30">
						...
						<div class="carousel_post_type3 nav_style1 owl-carousel">
							<div class="single_post post_type3">
								<div class="post_img">
									<img src="{{url('/')}}/mwangaza/assets/img/bg/video4.jpg" alt="">	<span class="tranding">
					...
					<div class="widget tab_widgets mb30">
						<div class="single_post widgets_small">
							<div class="post_img">
								<div class="img_wrap">
									<img src="{{url('/')}}/mwangaza/assets/img/blog/blog_small4.jpg" alt="">
