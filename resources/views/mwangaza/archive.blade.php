	...
	<div class="inner_table">
		<div class="container">
			...
			<div class="space-50"></div>
                <div class="table_content border_black_left">
                    <h2 class="widget-title">Mikoa</h2>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="yearList">
                                <ul>
                                    <li><a href="#">Dar es salaam</a>
                                    </li>
                                    <li><a href="#">Arusha</a>
                                    </li>
                                    <li><a href="#">Kilimajaro</a>
                                    </li>
                                    <li><a class="active" href="#">Mbeaya</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="yearList">
                                <ul>
                                    ...
                                    <li><a class="active" href="#">Iringa</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="yearList">
                                <ul>
                                    <li><a href="#">Mrorogoro</a>
                                    </li>
                                    <li><a href="#">Tanga</a>
                                    </li>
                                    <li><a href="#">Mtwara</a>
                                    </li>
                                    <li><a class="active" href="#">Sumbawanga</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
