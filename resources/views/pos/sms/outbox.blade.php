...
<div class="container">
	...
	<div class="d-flex flex-row">
		...
		<!--end::Aside-->
		<!--begin::List-->
		<div class="flex-row-fluid ml-lg-8 d-block" id="">
			<!--begin::Card-->
                            ...
                            <div class="d-flex align-items-start list-item card-spacer-x py-3"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap w-xxl-100px mr-3"
                                         data-toggle="view">
                                        <a href="#" class="font-weight-bold text-dark-75 text-hover-primary">{{$text->phone}}</a>
                                        <div class="mt-2">
                                            @if($text->status == 1)
                                                <span class="label label-light-primary font-weight-bold label-inline mr-1">Sent</span>
                                            @elseif($text->status == 0)
                                                <span class="label label-light-warning font-weight-bold label-inline">Pending</span>
                                            @elseif($text->status == 2)
                                                <span class="label label-light-success font-weight-bold label-inline">Delivered</span>
                                            @elseif($text->status == 3)
                                                <span class="label label-light-danger font-weight-bold label-inline">Failed</span>
                                            @else
                                                <span class="label label-light-danger font-weight-bold label-inline">Not Sent</span>
                                            @endif
                                        </div>
                                    </div>
                                    <!--end::Author-->
                                ...
                                <div class="flex-grow-1 w-200px mt-0 mr-2" data-toggle="view">
                                    <div>
                                        <p>Count: {{$text->sms_count}}</p>
                                    </div>
                                    <div>
                                ...
                                <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view">
                                    {{date('d, M Y',strtotime($text->created_at))}}
                                </div>
                                <!--end::Datetime-->
                            </div>
                            <!--end::Item-->
					...
					<div class="mb-3">
							...
							<div class="d-flex card-spacer-x py-6 flex-column flex-md-row flex-lg-column flex-xxl-row justify-content-between">
								<div class="d-flex align-items-center">
									<span class="symbol symbol-50 mr-4">
										<span class="symbol-label" style="background-image: url('../../../theme/html/demo1/dist/assets/media/users/100_13.jpg')"></span>
									</span>
							...
							<div class="d-flex card-spacer-x py-6 flex-column flex-md-row flex-lg-column flex-xxl-row justify-content-between">
								<div class="d-flex align-items-center">
									<span class="symbol symbol-50 mr-4" data-toggle="expand">
										<span class="symbol-label" style="background-image: url('../../../theme/html/demo1/dist/assets/media/users/100_11.jpg')"></span>
									</span>
									<div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
						...
						<div class="cursor-pointer shadow-xs toggle-off" data-inbox="message">
							...
							<div class="d-flex card-spacer-x py-6 flex-column flex-md-row flex-lg-column flex-xxl-row justify-content-between">
								<div class="d-flex align-items-center">
									<span class="symbol symbol-50 mr-4" data-toggle="expand">
										<span class="symbol-label" style="background-image: url('../../../theme/html/demo1/dist/assets/media/users/100_14.jpg')"></span>
									</span>
									<div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
										<div class="d-flex" data-toggle="expand">
