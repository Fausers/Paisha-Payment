<div class="flex-row-auto w-200px w-xxl-275px" id="kt_inbox_aside">
	<!--begin::Card-->
		...
		<div class="card-body px-5">
			...
			<div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
				...
				<div class="navi-item my-2">
					<a href="{{route('inbox')}}" class="navi-link {{Route::is('inbox') ? 'active' : null}}">
				...
				<!--begin::Item-->
				<div class="navi-item my-2">
					<a href="{{route('outbox')}}" class="navi-link {{Route::is('outbox') ? 'active' : null}}">
						<span class="navi-icon mr-4">
							<span class="svg-icon svg-icon-lg">
						...
						<span class="navi-text font-weight-bolder font-size-lg">Outbox</span>
					</a>
				</div>
				<!--end::Item-->
				<!--begin::Item-->
